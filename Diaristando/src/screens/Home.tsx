  ...
  return (
    <View className="flex-1 mx-6 py-10">
      ...
      <View className="flex gap-2 py-3">
        <Text className="text-base font-bold text-black">{t('h2-como-funciona')}</Text>
        <Text className="text-small text-black">{t('p-como-funciona')}</Text>
        <View className="my-3 gap-2">
          <StepComoFunciona step="01">
            <Text className="text-small leading-snug flex-1 text-black">
